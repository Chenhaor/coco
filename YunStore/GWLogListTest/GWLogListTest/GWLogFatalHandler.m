...
{
    static GWLogFatalHandler *_shareInstance = nil;

    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _shareInstance = [[GWLogFatalHandler alloc] init];
    });
...
- (void)validateAndSaveCrashData:(NSException *)exception
{
    ...
    [[GWLogListManager shareInstance] cacheLog:exceptionStr logType:LogType_ExceptionLog complementBlock:^{
        ...
        if (weakSelf.saveCrashDataBlock) {
            weakSelf.saveCrashDataBlock(exception);
        }
...
void HandleException(NSException *exception)
{
    ...
    [[GWLogFatalHandler shareInstance] performSelectorOnMainThread:@selector(handleException:)
