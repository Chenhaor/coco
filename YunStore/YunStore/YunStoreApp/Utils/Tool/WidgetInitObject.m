                         ...
                         title:(NSString *)atitle;
{
    ...
    if (nImageName) {
        [button setBackgroundImage:[UIImage imageNamed:nImageName] forState:UIControlStateNormal];
    }
    if (hImageName) {
        [button setBackgroundImage:[UIImage imageNamed:hImageName] forState:UIControlStateHighlighted];
    }
    if (atitle) {
